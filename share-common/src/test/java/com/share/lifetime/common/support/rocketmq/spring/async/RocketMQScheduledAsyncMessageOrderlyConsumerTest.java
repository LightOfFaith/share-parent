...
@Slf4j
public class RocketMQScheduledAsyncMessageOrderlyConsumerTest {

    public static void main(String[] args) throws MQClientException {
        AtomicLong consumeTimes = new AtomicLong(0);
        StopWatch stopWatch = new StopWatch("RocketMQScheduledAsyncMessageOrderlyConsumerTest");
        stopWatch.start();
        ...
        consumer.subscribe("Scheduled_Async_Orderly_Topic", "TagA");
